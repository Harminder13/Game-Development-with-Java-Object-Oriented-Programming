...
public class Date {
	...
	// Date constructor sets the date when user
	// gives it in the format, "Month/Day/Year"
	public Date(String strDate) {

		int i = 0;

		// Spiting the string after every "/"
		String[] arrOfStr = strDate.split("/", 3);

		// Storing each value in a variable
		String val = arrOfStr[i];
		String val2 = arrOfStr[i + 1];
		String val3 = arrOfStr[i + 2];

		// Converting the string to an integer and storing in variable
		int Month = Integer.parseInt(val);
		int Day = Integer.parseInt(val2);
		int Year = Integer.parseInt(val3);

		// setting the date using the setter method
	...
	// SetDate method created to set the date given a string
